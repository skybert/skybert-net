...
** Using a CLI file
You can put all your JBoss CLI commands in a file, say
=add-jdbc-driver.cli= and run it with:

#+begin_src text
$ /opt/jboss-as-7.1.1.Final/bin/jboss-cli.sh --connect --file=add-jdbc-driver.cli
#+end_src
